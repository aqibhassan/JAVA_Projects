                ...
                switch (CMD) {
                    ...
                    case "CMD_CHAT":
                        ...
                        try {
                             ...
                             * 
                             */
                            System.out.println("single chat server in.");
                            String content = from+" "+sendTo + " : " + msg;
                            dos.writeUTF("CMD_MESSAGE_TO " + content);
                    ...
                    case "CMD_SHARINGSOCKET":
                        main.appendMessage("CMD_SHARINGSOCKET : Clientset a socket for file sharing connection...");
